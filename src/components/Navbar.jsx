...
const Navbar = ({ isSidebarOpen, setIsSidebarOpen }) => {
  ...
  // Ensure that the setIsSidebarOpen is wrapped in useCallback
  ...
  return (
    <>
      <div
        className={`fixed top-0 left-0 h-full text-white bg-gray-900 shadow-xs shadow-gray-600 transition-all duration-300 ${
        ...
        <div className="flex flex-col flex-1 space-y-4 p-4 ">
          ...
          <div className="text-sm">
            ...
            <button
              ...
              onClick={() => {
                logoutUser();
                closeSidebar(); // Close the sidebar and logout
              }}
            >
              <FiLogOut size={20} />
      ...
      <div
        className={`md:hidden fixed top-0 left-0 w-full bg-gray-900 text-white p-4 flex justify-between items-center z-10 ${
